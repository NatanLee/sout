...
$mail->Subject = 'Сообщение руководителю';
$mail->Body    = 'Клиент, который представился как "' .$name. '" оставил заявку, его телефон ' .$phone. '<br>Его электронная почта - ' .$email. '<br>Сообщение:<br>' .$message;
