...
$mail->Subject = 'Вопросы от Клиента';
$mail->Body    = 'Клиент, который представился как "' .$name. '" оставил заявку, его телефон ' .$phone. '<br>Его электронная почта - ' .$email. '<br>Вопросы:<br>' .$message;
